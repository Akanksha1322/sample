                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        <div class="card">
                                ...
                                <div class="row m-0">
                                    <div class="col-sm-4">
                                        <div class="float-left">
                                            <strong class="card-title">Edit Contact</strong>
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                            ...
                            <form id="editContactForm" action="<?= base_url('admin-updatecontact/'.$edcontact[0]->id); ?>" method="post" enctype="multipart/form-data">
                                <div class="row pt-3">
                                    <div class="col-6">
                                        <div class="form-group ml-3">
                                            <label for="phone" class="control-label mb-1">Phone Number <span class="text-danger">*</span></label>
                                            <input type="text" id="phone" name="phone" class="form-control" value="<?= $edcontact['0']->phone ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group mr-3">
                                            <label for="email" class="control-label mb-1">Email <span class="text-danger">*</span></label>
                                            <input type="email" id="email" name="email" class="form-control" value="<?= $edcontact['0']->email ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row pt-2">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group ml-3 mr-3">
                                            ...
                                            <textarea type="text" id="address" name="address" rows="5" class="form-control"><?= $edcontact['0']->address ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
